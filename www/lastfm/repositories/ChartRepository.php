...
class ChartRepository extends BaseRepository
{
     ...
     * @return string
     */
    public function getTopArtists(int $page = 1, int $limit = 10): string
    {
     ...
     * @return string
     */
    public function getTopTracks(int $page = 1, int $limit = 10): string
    {
        return $this->baseRequest([
     ...
     * @return string
     */
    public function getTopTags(int $page = 1, int $limit = 10): string
    {
        return $this->baseRequest([
